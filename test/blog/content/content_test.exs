defmodule Blog.ContentTest do
  ...
  describe "posts" do
    ...
    @valid_attrs %{context: "some context", published: true, title: "some title"}
    @update_attrs %{context: "some updated context", published: false, title: "some updated title"}
    @invalid_attrs %{context: nil, published: nil, title: nil}
